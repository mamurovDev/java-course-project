...
public class Main implements Serializable {
  ...
  public Main(ConstructiveController constructiveController, DollController dollController,
              PuzzleController puzzleController, SoftController softController,
  ...
  public static void main(String[] args) {
    ...
    Main main = new Main(
            new ConstructiveController(new ConstructiveToyServiceImpl(new ConstructiveToyDAOImpl())),
